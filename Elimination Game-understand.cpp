/*
Problem Statement
arr is an array containing elements 1 to n. In the elimination game, two types of eliminations are done alternately on the array till one element remains.
